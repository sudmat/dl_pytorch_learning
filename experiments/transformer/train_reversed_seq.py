...
trainer = pl.Trainer(default_root_dir='experiments/transformer/models/seq_reverse/models/',
                     accelerator="gpu",
                     devices=1,
                     max_epochs=10,
...
model = ReversedSeqTransformer(
    in_dim=num_catoryies,
    num_classes=num_catoryies,
    model_dim=32,
    num_blocks=1,
    num_heads=1,
    linear_dim=64,
